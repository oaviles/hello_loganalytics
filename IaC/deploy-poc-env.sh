...
az functionapp create --resource-group $RESOURCE_GROUP --name $FUNCTION_NAME --os-type Windows --runtime dotnet --runtime-version 6 --functions-version 4 --storage-account $STORAGE_NAME --consumption-plan-location $REGION_NAME
